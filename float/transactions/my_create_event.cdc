...
import MyFLOATVerifiers from "../MyFLOATVerifiers.cdc"
...
transaction(
  ...
  requiredEventIdsForClaim: [UInt64]?,
) {
  ...
  execute {
    ...
    var ClaimBySpecifiedFLOATs: MyFLOATVerifiers.ClaimBySpecifiedFLOATs? = nil
    ...
    if let eventIds = requiredEventIdsForClaim {
      if eventIds.length > 0 {
        ClaimBySpecifiedFLOATs = MyFLOATVerifiers.ClaimBySpecifiedFLOATs(_eventIds: eventIds)
